const requestURL = 'http://localhost:4040/api/users';

const usersTableNavLink = document.getElementById("horizontal_navigation-users_table");
document.getElementById("horizontal_navigation-new_user");
        ...
        users.forEach((user) => {
            temp += `
                                <tr>
                                    ...
                                    <td> <button type="button" class="btn btn-danger" id="btn-delete-modal-call" data-id="${user.id}">Удалить</button></td>
                                </tr>
                        `
        })
...
document.getElementById("add-btn-submit");
